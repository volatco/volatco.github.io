...
Connection-pins are from the top of Volatco model 'a'. Model 'b' and 'c' dialects have receptacles in the -z direction and pins in the +z direction respective to the board.
