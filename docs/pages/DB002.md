---
layout: default
title: DataBook 002 - The GA144A12
permalink: /pages/db002/
---
...
- [1. Description](#description)
  ...
  - [1.2 Related Documents](#related-documents)
...
- [2. Chip Configuration](#chip-configuration)
  - [2.1 Array Layout and Pin Designation](#array-layout-and-pin-designation)
  - [2.2 Pin Functions](#pin-functions)
  - [2.3 Configuration of each node](#configuration-of-each-node)
...
- [3. ROM Software](#rom-software)
  ...
  - [3.3 Boot ROMs](#boot-roms)
    ...
    - [3.3.3 Asynchronous Boot ROM](#asynchronous-boot-rom)
    - [3.3.4 SPI Boot ROM](#spi-boot-rom)
  - [3.4 Other Special ROMs](#other-special-roms)
...
- [5. Electrical Characteristics](#electrical-characteristics)
  ...
  - [5.4 Variables Affecting Performance and Efficiency](#variables-affecting-performance-and-efficiency)
...
- [6. Mechanical Data](#mechanical-data)
  ...
  - [6.2 Physical Data](#physical-data)
    - [6.2.1 Peak Reflow Temperature](#peak-reflow-temperature)
...
This page describes the model GA144A12 Isolated-Linear Processor (ISLP), including its array and I/O configuration, pin-out, ROM contents, packaging, and its electrical and physical characteristics. In the interest of avoiding needless and often confusing redundancy, it is designed to be used in combination with other documents describing standard architecture and other components of the chip.

The general characteristics and programming details for the F18A computers and I/O used in the ISLP are described in a separate document; please refer to **F18A Technology Reference**. The boot protocols supported by this chip are detailed in **Boot Protocols for `GA144A12`.** 
...
## Array Layout and Pin Designation
...
| Name   | Pin | Type       | Description                                                                                                                                   | Notes |
|--------|-----|------------|-----------------------------------------------------------------------------------------------------------------------------------------------|-------|
...
| Computers / Nodes                                                                                            | Comm Ports Present | I/O Addressing | I/O Type      | Reset | ROM Type     | Special Config    | Notes |
|--------------------------------------------------------------------------------------------------------------|--------------------|---------------|---------------|-------|--------------|-------------------|-------|
...
| Thermal resistance, junction-to-mounting area          | RθJMA  | 20    | °C/W  |
...
|           |                                         | 0.1 μA, VDD=1.8V      |          |      | 1.98 | V     |
|           |                                         | 0.1 μA, VDD=1.6V      |          |      | 1.78 | V     |
...
The GA144A12 architecture makes it possible to dramatically reduce the energy required to perform useful work. Commitment, craftsmanship and attention to detail at all levels are rewarded by the realization of these economies.
...
|        |                                                                       | Pin to VSS, VDD = 1.8V | 1.1        | 1.5   | 5.6   | nA    |
...
|        |                                                                       | Pin to VSS, VDD = 1.8V | 1.59       | 1.65  | 1.67  | V     |
|        |                                                                       | Pin to VSS, VDD = 2.0V | 1.82       | 1.85  | 1.88  | V     |
| VOL    | Output low at 10 mA sink current                                      | Pin to VDD, VDD = 1.6V | 0.125      | 0.135 | 0.240 | V     |
|        |                                                                       | Pin to VDD, VDD = 1.8V | 0.110      | 0.125 | 0.270 | V     |
|        |                                                                       | Pin to VDD, VDD = 2.0V | 0.105      | 0.115 | 0.190 | V     |
...
|       |                                                         | Pin to VSS, output 0    | 1.1 | 1.5 | 5.6 | nA    |
